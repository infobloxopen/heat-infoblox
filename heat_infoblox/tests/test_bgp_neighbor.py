...
class BgpNeighborTest(common.HeatTestCase):
    def setUp(self):
        ...
        super(BgpNeighborTest, self).setUp()
    ...
    def set_stack(self, stack_template):
        ...
        self.bgp = self.stack['bgp_neighbor']
        self.bgp.infoblox_object = mock.Mock()

    def test_handle_create(self):
        self.set_stack(my_template)
        self.bgp.handle_create()
        opts = my_template['resources']['bgp_neighbor']['properties'].copy()
        self.bgp.infoblox_object.create_bgp_neighbor.assert_called_with(
            'member_name1', opts)
    ...
    def test_handle_delete(self):
        ...
        self.bgp.infoblox_object.delete_bgp_neighbor.assert_called_with(
            'member_name1', '192.168.165.25')

    def test_handle_update(self):
        self.set_stack(my_template)
        self.bgp.handle_create()
        props = my_template['resources']['bgp_neighbor']['properties'].copy()
