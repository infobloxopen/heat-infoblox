...
# these are broken in Kilo, need to be done manually

# create subnets for management and service
...
# create a router and attach it to the public network and the service network

#neutron router-create router --tenant-id $TENANT_ID
#neutron router-gateway-set router public
#neutron router-interface-add router service

# Be sure to enable traffic from outside into this security group
